 ...
 * @author user
 */
public class DaquPrintContentUtils {

    private static Logger logger = LoggerFactory.getLogger(DaquPrintContentUtils.class);
    ...
    public static void main(String[] args) {
        ...
        //组装打印内容-总单
        DaquPrintContentVo daquPrintContentVo = new DaquPrintContentVo("五天日记【松江印象城店】", "A01", "6", "刘大牙", voList, "98.60", "苏庆北路246号印象城B1-901", "021-09001234", 1, null);
        getMasterContent(daquPrintContentVo);
    }
     ...
     * @return
     */
    public static String getContent(DaquPrintContentVo printContentVo) {
        String result = "";
        try {
            int type = printContentVo.getType();
            if (ObjectUtils.isNotEmpty(type)) {
                if(1==type || 2==type){
                    getMasterContent(printContentVo);
                }
                else {
                    getMakeContent(printContentVo);
                }
            }
        } catch (Exception e) {
     ...
     * @return
     */
    public static String getMasterContent(DaquPrintContentVo printContentVo) {
        //开始组装
     ...
     * @return
     */
    public static String getMakeContent(DaquPrintContentVo makeContentVo) {
        //开始组装
        StringBuilder con = new StringBuilder();
...
//     * @return
//     */
//    public static String getCheckoutContent(DaquPrintContentVo printContentVo) {
//        //开始组装
//        StringBuilder con = new StringBuilder();
//        //居中 不加粗  放大2   店名
//        con.append("<C><font# bolder=0 height=2 width=2>").append(printContentVo.getStoreName()).append("</font#></C><BR>");
